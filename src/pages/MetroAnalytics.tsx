    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        >
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4">
            <KPIGaugeChart 
              value={kpis.passengerSatisfaction * 20} 
              max={100} 
              title="Satisfaction" 
              color="#8b5cf6" 
            />
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4">
            <KPIGaugeChart 
              value={kpis.maintenanceCompliance} 
              max={100} 
              title="Maintenance" 
              color="#ef4444" 
            />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
          ...
          <motion.div 
            ...
            className="bg-white rounded-xl shadow-sm border border-gray-200 p-6"
          >
            <h3 className="text-lg font-semibold text-gray-900 mb-4">Maintenance Cost Analysis</h3>
            <MaintenanceCostTrend height={350} />
          </motion.div>
        </div>
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full divide-y divide-gray-200">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {metroTrains.slice(0, 10).map((train) => (
                  <tr key={train.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                      {train.punctualityRate}%
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                      {train.performanceMetrics.meanTimeBetweenFailures}
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
