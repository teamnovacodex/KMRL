...
import { enterpriseTrains, historicalData } from '../data/enterpriseMockData';
import { 
...
import EnterpriseTrainAnimation from '../components/EnterpriseTrainAnimation';
...
const EnterpriseDashboard: React.FC = () => {
  ...
  const stats = {
    service: enterpriseTrains.filter(t => t.recommendation === 'Service').length,
    standby: enterpriseTrains.filter(t => t.recommendation === 'Standby').length,
    maintenance: enterpriseTrains.filter(t => t.recommendation === 'Maintenance').length,
    deepClean: enterpriseTrains.filter(t => t.recommendation === 'Deep Clean').length,
    criticalIssues: enterpriseTrains.filter(t => t.criticalJobCards > 0).length,
    expiredFitness: enterpriseTrains.filter(t => t.fitnessStatus === 'Expired').length,
          ...
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold text-gray-900 flex items-center space-x-3">
                ...
                <span>KMRL Enterprise Command Center</span>
              </h1>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-gray-500">of 25 total</p>
              </div>
